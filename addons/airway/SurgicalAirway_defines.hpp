...
#define ACM_SURGICAL_AIRWAY_INV_GRID_W (ACM_UI_CANVAS_W * 0.55)
#define ACM_SURGICAL_AIRWAY_INV_GRID_H (ACM_SURGICAL_AIRWAY_INV_GRID_W * 4/3)
#define ACM_SURGICAL_AIRWAY_INV_GRID_X (ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W - ACM_SURGICAL_AIRWAY_INV_GRID_W) / 2)
