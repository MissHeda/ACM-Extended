...
private _sync = _patient getVariable ["ACME_sync_armed", false];
[_patient, "shock", [_medic, _patient, _id, _epoch, _lastShock, _sync, CBA_missionTime]] call ACME_fnc_ownerDispatch;
