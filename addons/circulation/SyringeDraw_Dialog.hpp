...
class GVAR(SyringeDraw_Dialog) {
    ...
    class ControlsBackground {
        class Syringe_10_Backbit: RscPicture {
            ...
            x = QUOTE(ACM_UI_CANVAS_X + ((ACM_UI_CANVAS_W - ACM_SYRINGEDRAW_POS_W(42)) / 2));
        ...
        class MedicationListSelection: TopText {
            ...
            x = QUOTE(ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W / 2) + (ACM_UI_CANVAS_W / 3.05));
    ...
    class Controls {
        class Plunger: RscButton {
            ...
            style = 0;
            x = QUOTE(ACM_UI_CANVAS_X + ((ACM_UI_CANVAS_W - ACM_SYRINGEDRAW_POS_W(2.78)) / 2));
        ...
        class Button_Draw: RscButton {
            ...
            style = ST_CENTER;
            x = QUOTE(ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W / 2) - ((ACM_UI_CANVAS_W / 24) / 2) - ((ACM_UI_CANVAS_W / 24) * 1.1));
            y = QUOTE(safeZoneY + (safeZoneH / 1.2));
            w = QUOTE(ACM_UI_CANVAS_W / 24);
        ...
        class SwitchTargetInventory: RscButtonMenu {
            ...
            x = QUOTE(ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W / 2) + (ACM_UI_CANVAS_W / 3.1));
        ...
        class MedicationListPanel: RscListBox
        {
            ...
            x = QUOTE(ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W / 2) + (ACM_UI_CANVAS_W / 3.3));
            y = QUOTE(safeZoneY + (safeZoneH / 2) - (safeZoneH / 5.3));
            w = QUOTE(ACM_UI_CANVAS_W / 6.5);
