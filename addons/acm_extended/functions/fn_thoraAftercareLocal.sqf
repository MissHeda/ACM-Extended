/* Patient-owner aftercare for a completed surgical tract. No inventory or animation writes. */
...
[_patient, "activity", _message, [[_medic, false, true] call ace_common_fnc_getName, _side]] call ace_medical_treatment_fnc_addToLog;
