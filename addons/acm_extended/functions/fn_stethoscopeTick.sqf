...
private _gains = [_gx,_gy] call ACME_fnc_stethoscopeWeights;
...
for "_i" from 0 to 1 do {
    ...
    _gains set [_i,(_gains select _i) * _modifier];
};

// Keep the currently playing sounds running while moving. Native distance attenuation mixes
// these three local sources continuously; no global fadeSound or per-frame stop/restart is used.
{
