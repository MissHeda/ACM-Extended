...
private _midIV = [_patient, "Midazolam_IV", false] call ace_medical_status_fnc_getMedicationCount;
private _midIM = [_patient, "Midazolam", false] call ace_medical_status_fnc_getMedicationCount;
...
private _morphine = 0;
{
    private _value = [_patient, _x, false] call ace_medical_status_fnc_getMedicationCount;
