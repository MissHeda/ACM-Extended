...
private _sig = [
    ...
    _target getVariable ["ACME_Junc_Packing_leftarm", false],
    _target getVariable ["ACME_Junc_Packing_rightarm", false],
    _target getVariable ["ACME_Junc_Packing_leftleg", false],
    _target getVariable ["ACME_Junc_Packing_rightleg", false],
