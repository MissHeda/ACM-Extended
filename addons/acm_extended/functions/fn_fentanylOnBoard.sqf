...
private _equivMcg = 0;
{
    private _v = [_patient,_x,false] call ace_medical_status_fnc_getMedicationCount;
...
private _buccal = [_patient,"Fentanyl_BUC",false] call ace_medical_status_fnc_getMedicationCount;
