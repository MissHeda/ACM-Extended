/* Patient-owner commit. Receipts survive full heal so delayed retries cannot refund a committed cuff.
   The ledger grows with actual requests and ends with the patient's entity lifetime. */
params ["_patient", "_medic", "_bagId", "_epoch", "_id", "_issued", "_spent", ["_allowDrug", false]];
