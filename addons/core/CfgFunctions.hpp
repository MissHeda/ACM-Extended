class CfgFunctions {
    ...
    class overwrite_ace_common {
        ...
        class ace_common {
            class displayTextStructured {
                file = QPATHTOF(overrides\fnc_displayTextStructured.sqf);
            };
            class progressBar {
                file = QPATHTOF(overrides\fnc_progressBar.sqf);
            };
        };
    };
    ...
    class overwrite_medical_vitals {
        ...
        class ace_medical_vitals {
            ...
            class updatePeripheralResistance { // Native + Extended SVR composition
                file = QPATHTOF(overrides\fnc_updatePeripheralResistance.sqf); //ace/addons/medical_vitals/functions/fnc_updatePeripheralResistance.sqf
            };
    ...
    class overwrite_medical_status {
        ...
        class ace_medical_status {
            ...
            class getCardiacOutput { // True PEA mechanical output
                file = QPATHTOF(overrides\fnc_getCardiacOutput.sqf); //ace/addons/medical_status/functions/fnc_getCardiacOutput.sqf
            };
            // Fork-retained compatibility function: this target is absent from the supplied ACE3 baseline,
            // but ACM/ACME still owns the IV/transfusion volume transaction under the public ACE symbol.
    ...
    class overwrite_medical_treatment {
        ...
        class ace_medical_treatment {
            ...
            class addToLog { // Extended contact/log terminology
                file = QPATHTOF(overrides\fnc_addToLog.sqf); //ace/addons/medical_treatment/functions/fnc_addToLog.sqf
            };
