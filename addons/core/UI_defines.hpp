...
#define ACM_GUI_GRID_W (ACM_UI_CANVAS_W * 0.55)
#define ACM_GUI_GRID_H (ACM_GUI_GRID_W * 4/3)
#define ACM_GUI_GRID_X (ACM_UI_CANVAS_X + (ACM_UI_CANVAS_W - ACM_GUI_GRID_W) / 2)
...
#define ACM_GRID_H ((((ACM_UI_CANVAS_W / ACM_UI_CANVAS_H) min 1.2) / 1.2) / 22)