...
private _acmeBinding = "NA3:handleEffects";
_pain = _pain max (((ACE_player getVariable ["ACME_rhythm_painContribution", 0]) - (ACE_player getVariable ["ace_medical_painSuppress", 0])) max 0);
