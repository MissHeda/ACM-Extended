...
The cumulative release still needs a complete local build and in-game verification. See the validation section in the main notes and the detailed checks in each patch record.
